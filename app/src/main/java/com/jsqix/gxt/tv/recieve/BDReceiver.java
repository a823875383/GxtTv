...
import com.jsqix.gxt.tv.activity.SplashActivity;
...
/**
 * Created by dongqing on 2016/10/31.
 * <p>
...
public class BDReceiver extends PushMessageReceiver {
    /**
     * TAG to Log
     */
    public static final String TAG = BDReceiver.class
            .getSimpleName();
    ...
    public void onSetTags(Context context, int errorCode,
        ...
        // Demo更新界面展示代码，应用请在这里加入自己的处理逻辑
//        updateContent(context, responseString);
        if (SplashActivity.istance != null) {
            if (errorCode == 0) {
                SplashActivity.istance.jump2Login();
            } else {
                SplashActivity.istance.setAliasAndTag();
            }
        }
    }
