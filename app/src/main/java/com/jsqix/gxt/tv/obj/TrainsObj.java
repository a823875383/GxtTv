...
public class TrainsObj extends BaseObj {
	private String train_no;/* 车编号 */
	private String station_train_code;/* 车次 */
	private String start_station_telecode;/* 车次始发站编号 */
	private String start_station_name;/* 车次始发站 */
	private String end_station_telecode;/* 车次终点站编号 */
	private String end_station_name;/* 车次终点站 */
	private String from_station_telecode;/* 车次出发站编号 */
	private String from_station_name;/* 出发站 */
	private String to_station_telecode;/* 车次到点站编号 */
	...
	private String train_class_name;/* 车次类型 */
	private String lishi;/* 总历时时间 */
	private String canWebBuy;/* 能不能买 */
	private String lishiValue;/* */
	private String yp_info;/* */
	private String control_train_day;/* */
	private String start_train_date;/* 出发日期 */
	private String seat_feature;/* 类型 */
