...
public class PackageUtils {
     ...
     * @return
     */
    public static CommandResult startApk(String packageName, String activityName) {
     ...
     * @return
     */
    public static CommandResult startApk(String packageName, String activityName, boolean selfStart) {
        if (selfStart) {
            String command = "am start --user 0 -n " + packageName + "/" + activityName
                    + " \n";
            CommandResult commandResult = ShellUtils.execCommand(command, false);
            return commandResult;
        } else {
            return startApk(packageName, activityName);
        }
    }
    ...
    // /**
    // * whether the app whost package's name is packageName is on the top of
    // the stack
    // * <ul>
    // * <strong>Attentions:</strong>
    ...
    // retun whether the app is on the top of
    // * stack
    // */
    ...
    // * @param packageName
    // */
    // public static void startInstalledAppDetails(Context context, String
    // packageName) {
