...
public class BDVideoViewActivity extends Activity implements ViewFactory,
	...
	private void initData() {
		...
		anims.add(AnimationUtils.loadAnimation(this,
...
//		localList.add("assets/sy_ad3.jpg");
//		localList.add("assets/sy_ad4.jpg");
//		localList.add("assets/sy_ad5.jpg");
//		localList.add("assets/sy_ad6.jpg");
		getAds();
		startQuery();
	}
	...
	private void start() {
		...
		task1 = new TimerTask() {
			...
			public void run() {
				...
				if (url.startsWith("http://") &&(BitmapHelp.isImage(url)||BitmapHelp.isVideo(url)) ) {
